...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loading && !isLoginPage) {
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center text-white antialiased">
  ...
  return (
    // Layout com sidebar (páginas protegidas) - Adicionado bg-zinc-950 e text-white na div pai
    <div className="min-h-screen flex bg-zinc-950 text-white antialiased">
      {/* Sidebar Fixa */}
